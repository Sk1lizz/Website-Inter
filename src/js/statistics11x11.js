...
const goalsData = [
    ...
    { number: "2.", name: "Волконский", counter: "9" },
...
const assistsData = [
    ...
    { number: "5.", name: "Волконский", counter: "2" },
    { number: "6.", name: "Петрищев", counter: "4" },
    { number: "7.", name: "Шаропов", counter: "3" },
...
const zanettiTopData = [
    ...
    { name: "Белов", training: 2 },
    { name: "Белоножкин", training: 11 },
    { name: "Бутин", training: 11 },
    { name: "Власов", training: 16 },
    { name: "Волконский", training: 27 },
    { name: "Иванов", training: 27 },
    { name: "Долгов", training: 23 },
    { name: "Швамбергер", training: 19 },
    { name: "Исаев", training: 9 },
    { name: "Пашаев", training: 4 },
    { name: "Клеменой", training: 7 },
    { name: "Королев Д.", training: 34 },
    { name: "Королев И.", training: 23 },
    { name: "Костич", training: 16 },
    { name: "Кулигин", training: 5 },
    { name: "Ларин", training: 12 },
    { name: "Матвеев", training: 47 },
    { name: "Мкома", training: 1 },
    { name: "Нишанов", training: 9 },
    { name: "Мищенко", training: 3 },
    { name: "Петрищев", training: 46 },
    { name: "Полевой", training: 20 },
    { name: "Родионов", training: 0 },
    { name: "Тапчан", training: 0 },
    { name: "Савельев", training: 11 },
    { name: "Салимгареев", training: 33 },
    { name: "Свирщевский", training: 13 },
    { name: "Сыпченко", training: 24 },
    { name: "Амири", training: 37 },
    { name: "Шаропов", training: 44 },
    { name: "Шеин", training: 43 },
    { name: "Штепа", training: 11 },
