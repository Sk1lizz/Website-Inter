...
const zanettiTopData = [
    ...
    { name: "Эрик", training: 4 },
    { name: "Ларин", training: 17 },
    { name: "Лешанков", training: 15 },
    { name: "Матвеев", training: 61 },
    { name: "Мкома", training: 2 },
    { name: "Нишанов", training: 9 },
    { name: "Мищенко", training: 3 },
    { name: "Петрищев", training: 58 },
    { name: "Пожидаев", training: 31 },
    { name: "Полевой", training: 30 },
    { name: "Родионов", training: 0 },
    { name: "Тапчан", training: 0 },
    { name: "Савельев", training: 11 },
    { name: "Салимгареев", training: 45 },
    { name: "Свирщевский", training: 29 },
    { name: "Стребков", training: 17 },
    { name: "Сыпченко", training: 31 },
    { name: "Устинов", training: 9 },
    { name: "Филимонов", training: 5 },
    { name: "Амири", training: 46 },
    { name: "Шаропов", training: 59 },
    { name: "Шеин", training: 60 },
