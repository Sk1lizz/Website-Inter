...
const zanettiTopData = [
    ...
    { name: "Ларин", training: 25 },
    { name: "Лешанков", training: 18 },
    { name: "Макаров", training: 6 },
    { name: "Матвеев", training: 69 },
    { name: "Мкома", training: 3 },
    { name: "Норванов", training: 1 },
    { name: "Нишанов", training: 9 },
    { name: "Мищенко", training: 3 },
    { name: "Петрищев", training: 58 },
    { name: "Пожидаев", training: 31 },
    { name: "Полевой", training: 38 },
    { name: "Родионов", training: 0 },
    { name: "Тапчан", training: 0 },
    { name: "Савельев", training: 11 },
    { name: "Салимгареев", training: 47 },
    { name: "Свирщевский", training: 35 },
    { name: "Стребков", training: 22 },
    { name: "Сыпченко", training: 33 },
    { name: "Устинов", training: 9 },
    { name: "Филимонов", training: 8 },
    { name: "Амири", training: 53 },
    { name: "Шаропов", training: 67 },
    { name: "Шеин", training: 66 },
    { name: "Штепа", training: 18 },
    { name: "Эрик", training: 12 },
    { name: "Юсуф", training: 9 },
    { name: "Майоров", training: 5 },
    { name: "Сафаров", training: 5 },
